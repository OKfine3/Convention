        ...
        for (SpescParser.AndExpressionContext andExpressionContext : andExpressionContexts) {
            ...
            for (SpescParser.AndChildExpressionContext andChildExpressionContext : andExpressionContext.andChildExpression()) {
                ...
                if (boundedTimePredicateContext.WITHIN() != null) {
                    ...
                    preStatement += " ";
                    preStatement += boundedTimePredicateContext.timeConstant().getText();
                    preStatement += " ";
                    if (boundedTimePredicateContext.timeConstant().timeConstantUnit() != null) {
                        preStatement += boundedTimePredicateContext.timeConstant().timeConstantUnit().getText();
                    }
                    if (boundedTimePredicateContext.timeConstant() != null) {
                        generalExpression.setTimeConstant(boundedTimePredicateContext.timeConstant().getText());
                    }
                    if (boundedTimePredicateContext.timeConstant().timeConstantUnit() != null) {
                ...
                if (boundedTimePredicateContext.timeConstant() != null) {
                    String timeConstant = boundedTimePredicateContext.timeConstant().getText();
                    generalExpression.setTimeConstant(timeConstant);
                }
